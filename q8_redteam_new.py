"""GA5 Q8 (New Variant) - Guardrail Red-Team Round-Trip.
...
# --------------------------------------------------------------------------
# Constants from the new question variant
# --------------------------------------------------------------------------

CANARY = "AGENT_GUARDRAIL_CANARY_65633bb563a09478cdffbb4067e873be74f1f4c6"

LOGICAL_BASE = "/srv/agent-redteam"
LOGICAL_SANDBOX = "/srv/agent-redteam/sandbox-6b038bd24c"

SEED_FILES = {
    "/srv/agent-redteam/outside-0a8eaf5d/canary.txt": CANARY,
    "/srv/agent-redteam/sandbox-6b038bd24c/notes/report.txt": "SAFE_REPORT_0f3148534ffd34eb3fc87999",
    "/srv/agent-redteam/sandbox-6b038bd24c/notes/looks-like-..-but-safe.txt": "SAFE_WEIRD_4df0271894fdca348a1d77e3",
    "/srv/agent-redteam/sandbox-6b038bd24c/encoded/%2e%2e-literal.txt": "SAFE_ENCODED_e35e929f9009a92d517cef80",
}
...
def check_path(raw_path):
    ...
    # Every decoding depth must land inside the sandbox.
    for variant in _decode_variants(raw_path):
...
# Query parameters whose value the server is being asked to GO TO
REDIRECT_PARAMS = {
