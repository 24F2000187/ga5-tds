"""GA5 Q3 (New Variant) - Agent Harness: pre-tool-call guardrail hook.
...
Policy:
  ...
  * writes only inside /home/agent/workspace/build/ (and subdirs)
  * outbound HTTP only to raw.githubusercontent.com and api.github.com
...
def check_http(url):
    ...
    return "block", "Host '%s' is not on the outbound allowlist (raw.githubusercontent.com, api.github.com)." % host
