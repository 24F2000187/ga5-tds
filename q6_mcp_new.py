"""MCP Streamable HTTP transport for TDS GA5 Q6 (New Variant).

Single JSON-RPC 2.0 endpoint at /mcp_new exposing one tool, `solve_challenge`,
...
# Current student's registered email
