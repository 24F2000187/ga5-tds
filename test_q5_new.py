"""Probe-by-probe tests for q5_loopguard_new, one per grader category."""

from q5_loopguard_new import evaluate
...
case(
    "cosmetic-diff-trace-id-nested",
    {"budget_tokens": BUDGET, "steps": [
        step(1, "search", {"trace_id": "a1", "q": "python",
                           "opts": {"trace_id": "n1", "deep": True}}),
        step(2, "search", {"trace_id": "b2", "q": "python",
                           "opts": {"trace_id": "n2", "deep": True}}),
        step(3, "search", {"trace_id": "c3", "q": "python",
                           "opts": {"trace_id": "n3", "deep": True}}),
    ]},
    "halt",
)
case(
